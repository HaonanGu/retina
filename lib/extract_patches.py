...
def get_data_training(DRIVE_train_imgs_original,
    ...
    train_masks=np.zeros([total_data,1,train_imgs_original.shape[2],train_imgs_original.shape[3]])


    train_masks_temp = load_hdf5(DRIVE_train_groudTruth+'.hdf5')#[img_id:img_id+1]#masks always the same
...
def get_data_testing(DRIVE_test_imgs_original, DRIVE_test_groudTruth, Imgs_to_test, patch_height, patch_width,num_lesion,total_data):
    ...
    test_masks=np.zeros([total_data,1,test_imgs_original.shape[2],test_imgs_original.shape[3]])


    test_masks_temp = load_hdf5(DRIVE_test_groudTruth +'.hdf5')#[img_id:img_id+1]#masks always the same
...
def get_data_testing_overlap(DRIVE_test_imgs_original, DRIVE_test_groudTruth, Img_id, patch_height, patch_width, stride_height, stride_width,num_lesion,total_data):
    ### test
    ...
    test_masks_temp = load_hdf5(DRIVE_test_groudTruth)#[img_id:img_id+1]#masks always the same

    test_masks=test_masks_temp[Img_id:Img_id+1,:,:,:]
    test_imgs = my_PreProc(test_imgs_original)
